    ...
    return(
        <section className="max-container padding-container flex flex-col gap-20 py-10 md:gap-28 lg:py-20 xl:flex-row">
            ...
            <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
                ...
                <p className="reguler-16 mt-6 text-gary-30 xl:max-w-[520px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum nostrum quae quos, odio nemo tempore animi. Quod possimus vitae facilis ipsa nobis rem, aspernatur nesciunt autem, asperiores dolor dicta obcaecati?</p>
                <div className="my-11 flex flex-wrap gap-5">
                    ...
                    <p className="bold-16 lg:bold-20 text-blue-70">198k
                        <span className="reguler-16 lg:reguler-20 ml-1 underline">Exellent Reviews</span>
                    </p>
                </div>
